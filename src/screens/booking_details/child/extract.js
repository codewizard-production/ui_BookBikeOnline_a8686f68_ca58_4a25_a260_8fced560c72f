...
const MapItems = [
    { navpropname: "Bike", uicomponent: "bikebike", expand: "Bike", exclude: [], func: Support.AddOrUpdateBike }
,    { navpropname: "", uicomponent: "booking", expand: "", exclude: [], func: Support.AddOrUpdateBooking }
]
    ...
    return new Promise(async (resolve) => {
        ...
        if (bookingId) {
            ...
            if ($expand.length > 0) {
                ...
                rslt = await Api.GetBookingSingle(bookingId);
            }
